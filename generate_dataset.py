...
# Get output dir name
out_dir = os.path.join(args.dataset, 'dataset_our_codification_250ms')
...
export_file_dict = {os.path.join(args.dataset, 'run2', 'rec1487339175_export.hdf5'): [[0, 4150], [5200, 6600]],
                    os.path.join(args.dataset, 'run5', 'rec1487842276_export.hdf5'): [[1310, 1400], [1900, 2000], [2600, 3550]],
                    os.path.join(args.dataset, 'run3', 'rec1487593224_export.hdf5'): [[870, 2190]],
                    os.path.join(args.dataset, 'run5', 'rec1487846842_export.hdf5'): [[380, 500], [1800, 2150], [2575, 2730], [3530, 3900]],
                    os.path.join(args.dataset, 'run3', 'rec1487417411_export.hdf5'): [[100*every_index, 1500*every_index], [2150*every_index, 3100*every_index], [3200*every_index, 4430*every_index], [4840*every_index, 5150*every_index]],
                    os.path.join(args.dataset, 'run3', 'rec1487356509_export.hdf5'): [[2900, 3100]],
                    os.path.join(args.dataset, 'run4', 'rec1487779465_export.hdf5'): [[1800, 3400], [4000, 4700], [8400, 8630], [8800, 9160], [9920, 10175], [18500, 22300]]}



# contains the filename of the test subsequence
test_file = os.path.join(args.dataset, 'run3', 'rec1487417411_export.hdf5')
other_file = os.path.join(args.dataset, 'run3', 'rec1487356509_export.hdf5')
